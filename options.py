...
# New: Genre vocabulary size (padding index 0 plus 6 genres)
parser.add_argument('--genre_vocab_size', type=int, default=7, help='Genre vocabulary size (including padding index 0)')
# DAE parameters (unchanged)
